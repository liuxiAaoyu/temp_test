...
parser.add_argument('--resume', type=str, default='/home/xiaoyu/Documents/Segmentation/densenet121HDCUDC.params',
...
metric = CompositeEvalMetric([ metrics.IoUMetric(ignore_label=5, label_num=5), metrics.SoftmaxLoss(ignore_label=5, label_num=5)])
